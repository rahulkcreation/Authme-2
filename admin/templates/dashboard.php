...
<div class="authme-admin-wrap" id="authme-admin-dashboard">
    ...
    <div class="authme-admin-section">
        ...
        <div class="authme-admin-info-box" style="margin-bottom:16px;">
            <p><strong>6. Universal Logout — Direct URL</strong></p>
            <p style="font-size:13px; color:#64748b; margin-top:4px;">Share this link anywhere to securely log out the current user and redirect them back to the homepage. This works natively for any user session.</p>
            <code class="authme-admin-code"><?php echo esc_url( home_url( '/?authme_logout=1' ) ); ?></code>
        </div>
